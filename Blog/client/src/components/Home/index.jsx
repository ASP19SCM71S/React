      ...
      <div className="container">
        <div className="row pt-5">
          <div className="col-12 col-lg-6 offset-lg-3">
            <img  className="img-thumbnail" src="https://storage.needpix.com/rsynced_images/blog-606684_1280.png" alt="blog"></img>
          </div>
          <Form />
        </div>
        <div className="row pt-5">
              ...
              return (
                <div className="card my-3">
                  ...
                  <div className="card-footer">
                    <div className="row">
                      <button  onClick={() => this.handleEdit(article)} className="btn-success mx-3" >
                        Edit
                      </button>
